...
<!-- GLITCH HEADER -->
<img src="https://capsule-render.vercel.app/api?type=venom&color=0:0D1117,50:003399,100:0066FF&height=200&section=header&text=PRATHAM%20PATADIYA&fontSize=60&fontColor=FFFFFF&animation=fadeIn&stroke=00AAFF&strokeWidth=2&desc=⟦%20SYSTEM%20NODE%20ONLINE%20⟧%20AI%20%7C%20SVNIT%20%7C%20BUILDER&descAlignY=78&descSize=18&descColor=CCE0FF&reversal=true" width="100%"/>
...
```yaml
# /etc/pratham/identity.conf

name:        "Pratham Patadiya"
handle:      "@Pratham722007"
institution: "SVNIT Surat — B.Tech AI"
location:    "Gujarat, India 🇮🇳"
status:      ONLINE ✦

mission: >
  Merge the gap between imagination
  and computation. Build systems
  that don't just execute — they think.

current_focus:
  - ML pipelines & LLM integration
  - Full-stack AI web platforms
  - Competitive DSA grind

motto: "CODE IS ART. AI IS THE BRUSH."
```
...
class Pratham:
    def __init__(self):
        self.brain   = ["ML", "LLMs", "DSA"]
        self.hands   = ["React", "Django", "Next.js"]
        self.soul    = ["Hackathons", "Open Source"]
        self.rating  = 1407  # LeetCode max
...
<br><br>
<img src="https://skillicons.dev/icons?i=git,github,linux,vercel,postman,vscode,postgres,figma&theme=dark&perline=8" />
...
│  LAYER 0x02  ░░  INTERFACE    React ████████ Next.js ███████ Tw ███ │
...
└──────────────────┘
```
**Stack:** `Django` · `React` · `AI`

Real-time cricket platform with **AI-powered Q&A**, live analysis, quizzes & player insights. Built for fans who demand more than just scores.

![Django](https://img.shields.io/badge/-Django-0D1117?style=flat-square&logo=django&logoColor=00AAFF)
![React](https://img.shields.io/badge/-React-0D1117?style=flat-square&logo=react&logoColor=00AAFF)
...
└──────────────────┘
```
**Stack:** `AI` · `Django` · `Gamification`

Gamified AI platform to **report illegal environmental activity**. Turning civic duty into an engaging, rewarding experience.

![AI](https://img.shields.io/badge/-AI%20Core-0D1117?style=flat-square&logo=openai&logoColor=00AAFF)
![Django](https://img.shields.io/badge/-Django-0D1117?style=flat-square&logo=django&logoColor=00AAFF)
...
Production-grade **mental wellness platform** — helping people navigate life's chaos with clarity. Because code can heal too.

![Next.js](https://img.shields.io/badge/-Next.js-0D1117?style=flat-square&logo=next.js&logoColor=00AAFF)
![Supabase](https://img.shields.io/badge/-Supabase-0D1117?style=flat-square&logo=supabase&logoColor=00AAFF)
...
[![LinkedIn](https://img.shields.io/badge/LINKEDIN-Pratham%20Patadiya-0066FF?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=0D1117)](https://www.linkedin.com/in/pratham-patadiya-4b1344300/)
&nbsp;
[![Gmail](https://img.shields.io/badge/GMAIL-patadiyapratham98-00AAFF?style=for-the-badge&logo=gmail&logoColor=white&labelColor=0D1117)](mailto:patadiyapratham98@gmail.com)
&nbsp;
[![GitHub](https://img.shields.io/badge/GITHUB-Pratham722007-003399?style=for-the-badge&logo=github&logoColor=white&labelColor=0D1117)](https://github.com/Pratham722007)
...
<img src="https://capsule-render.vercel.app/api?type=shark&color=0:0D1117,50:002299,100:0066FF&height=100&section=footer&text=TRANSFORMING+COMPLEXITY+INTO+COMPUTATIONAL+ELEGANCE&fontSize=14&fontColor=CCE0FF&animation=twinkling&reversal=true" width="100%"/>
