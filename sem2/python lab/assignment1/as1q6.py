...
# Function to calculate the distance between two points in 3-D space
def distance(point1, point2):
    return math.sqrt((point1[0] - point2[0])**2 + (point1[1] - point2[1])**2 + (point1[2] - point2[2])**2)

# List of 10 3-D points
# Function to take input of 3D coordinates
...
# Finding the nearest neighbor for each point
nearest_neighbors = []
